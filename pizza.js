...
class Pizza {
    ...
    describe(){
        return `This pizza is ${this.size} is, the sauce chosen is ${this.sauce},
        and the toppings you picked are ${this.toppings}`
    }
}

const pizza = new Pizza(22, 'tomato', ['sausage, cheese, bacon'])
